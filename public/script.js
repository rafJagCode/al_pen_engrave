...
function onClick_add() {
	...
	const preview = document.querySelector("#screenshot");
	try {
		html2canvas(preview, {
			scrollX: 0,
			scrollY: 0,
			...
			onclone: function (clonedDoc) {
				clonedDoc.getElementById('screenshot').style.height = '1000px';
				clonedDoc.getElementById('screenshot').style.left = '50%';
				clonedDoc.getElementById('screenshot').style.position = 'absolute';
				clonedDoc.getElementById('grawer_preview_image').style.position = 'absolute';
				clonedDoc.getElementById('grawer_preview_image').style.top = '50%';
				clonedDoc.getElementById('grawer_preview_image').style.left = '50%';
				clonedDoc.getElementById('grawer_preview_image').style.transform = 'translate(-50%, -50%)';
			},
		}).then(canvas => {
			// document.getElementById('content-wrapper').appendChild(canvas);
